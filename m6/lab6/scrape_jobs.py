...
def scrape_jobs(chromedriver_path, url):
    ...
    job_elements = driver.find_element(By.CLASS_NAME, "link-job-wrap")
    ...
    for job_element in job_elements:
        ...
        job["title"]=job_element.get_attribute("h2").text
        job["company"]=job_element.get_attribute("card__job-empname-label").text
        try:
            job["image_url"]=job_element.get_attribute("card__job-logo").text
        except Exception: 
            job["image_url"]=None
